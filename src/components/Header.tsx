    ...
    <header className="sticky top-0 z-40 bg-white/90 backdrop-blur-sm border-b border-surface-border">
      <div className="section-container flex items-center justify-between h-16">
        <Link href="/" className="flex items-center shrink-0">
          <Image src="/brand/modern-trades-logo.png" alt="Modern Trades" width={168} height={56} className="hidden sm:block h-9 w-auto" priority />
          <Image src="/brand/modern-trades-mark.png" alt="Modern Trades" width={56} height={56} className="sm:hidden h-9 w-9" priority />
        </Link>
        ...
        <a href="https://www.moderntradescrm.com" className="btn-primary !px-5 !py-2 !text-sm shrink-0">See Modern Trades CRM</a>
      </div>
    </header>
  )
}
